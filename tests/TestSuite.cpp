...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UnitTest::TestToolBoxHash, "tests");
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UnitTest::TestStringFactory, "tests");
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UnitTest::TestTrieToStr, "tests");
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UnitTest::TestStrTrieInterpreter, "tests");
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UnitTest::TestStrBTree, "tests");
